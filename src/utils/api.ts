...
import { Channel, CountryMeta } from '../types/iptv';
...
export const getCountriesByLang = (langCode: string): string[] => {
  switch (langCode) {
    case 'spa': // Spanish
      return ["AR", "AW", "BZ", "BO", "CL", "CO", "CR", "CU", "DO", "EC", "SV", "FK", "GF", "GT", "GY", "HT", "HN", "MX", "AN", "NI", "PA", "PY", "PE", "GS", "SR", "TT", "UY", "VE"];
    // TODO: dummy AI gen data below, complete with accurate lists
    case 'eng': // English
      return ['AU', 'CA', 'GB', 'IE', 'NZ', 'US', 'ZA'];
    case 'fra': // French
      return ['BE', 'CA', 'FR', 'CH'];
    case 'ger': // German
      return ['AT', 'DE', 'CH'];
...
export const getUserMeta = async (fallbackLocale?: string) => {
